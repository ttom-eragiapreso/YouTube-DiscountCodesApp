...
//        request.setVideoCategoryId("1");
//        request.setKey(API_KEY);
//        request.setChart("mostPopular");
//        request.setRegionCode(regionCode);
//        request.setMaxResults(250L); // You can adjust the number of popular videos to retrieve
...
//        VideoListResponse response = request.execute();
//        List<Video> items = response.getItems();
//        items = items.stream().filter(v -> v.getSnippet().getDescription().contains("sconto")).toList();
